...
val patents = listOf(
    Patent(
        ...
        url = "https://register.dpma.de/DPMAregister/pat/register?AKZ=1020221056805"
    ),
    Patent(
        id = 1,
        ...
        url = "https://register.dpma.de/DPMAregister/pat/register?AKZ=1020221056856"
    ),
    Patent(
        id = 2,
        ...
        url = "https://register.dpma.de/DPMAregister/pat/register?AKZ=1020221056872"
    )
)
